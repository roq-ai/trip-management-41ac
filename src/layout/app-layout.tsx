...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'travel-planner', 'customer-service-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Booking', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiBook },
    {
      name: 'Travel Plan',
      path: '/travel-plans',
      entity: 'travel_plan',
